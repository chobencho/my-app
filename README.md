...
　これが**コードを書くことで提供する価値の本質**であると感じました。<br>
 プログラミングすることを目的とするならば、すでにある仕様書通りに作れば良いが、本来の目的はその先にいる**ユーザに楽しい時間を提供すること**です。<br>
...
- **毎日が小さな挑戦！いつの間にか成長している自分**<br>
  ...
  瞬間的な苦しさもありますが、**毎日新しいことができるようになる楽しさ・面白さ**を実感しています。小さな達成感が積みあがっていく感覚は他にはないと思いました。<br>
  ふと1カ月前を思い返すと、いつの間にか成長した自分が見えてきました。**自分の目標を自分でたてて着実に努力することの大切さ**を実感しています。<br>

- **技術に対する興味が深くなった**<br>
　この挙動どうやって実現するの？？どんな技術を使っているの？？なんでこんなにレスポンス早いの？？と興味を持つ視点が変わりました。<br>
　それらを実現するためのまだまだわからないことは多いのでもっと吸収して成長したい。<br>
...
- **今後はもっと幅広く**<br>
　今後は、ひとつの技術だけでなくサーバー・フロント・インフラ等の幅広いスキルを身に着けられるように動いてフルスタックを目指します。<br>
　グローバルなサービス視点も持てるように、色んなサービスを触ってみてインプット量も増やしていきたい。<br>
