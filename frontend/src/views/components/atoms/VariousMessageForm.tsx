...
export interface VariousMessageFormProps {
...
const VariousMessageForm = ({
    handleGetData,
    id,
    stringMyId,
    another_id,
    discrimination,
}: VariousMessageFormProps) => {
    ...
    const handleCreateCommonMessageForm = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
...
export default VariousMessageForm;
