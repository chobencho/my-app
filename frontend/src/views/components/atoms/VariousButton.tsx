...
const VariousButton = ({ buttonTitle, toLink, verifiedAge, classContent }: VariousButtonProps) => {
    const navigate = useNavigate();
    return (
        <div className={`text-center my-5 ${classContent}`}>
            <button
                className={`relative border w-1/2 max-w-xs rounded-3xl p-3 bg-blue-base text-white`}
