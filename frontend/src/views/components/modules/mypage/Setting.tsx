    ...
    return (
        <>
            <div className="border mt-5">
                <Link
                    to="https://forms.gle/kpaBRnfEpxKqvx1KA"
                    target="_blank"
            ...
            {showPolicyModal ? <ModalPrivacyPolicy onClose={handleCloseModal} /> : null}
            {showDeleteModal ? <ModalDeleteAccount onClose={handleCloseModal} /> : null}
        </>
    );
};
