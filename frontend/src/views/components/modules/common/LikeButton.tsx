...
const LikeButton = ({ myId, generalId, generalData, handleData, discrimination }: LikeProps) => {
    // State
    ...
    const handleGetLike = async () => {
        getLike(myId, generalId, model, controller).then((res) => setLike(res.data));
    };
    ...
    return (
        <div className="absolute right-0 top-1">
            ...
            >
                <FaHeart
                    className={`text-base mx-1 sm:text-lg ${like ? 'text-red-400' : ''} ${
