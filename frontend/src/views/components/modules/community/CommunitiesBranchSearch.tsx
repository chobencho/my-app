...
import CommunityBlock from 'views/components/block/community/CommunityBlock';
...
const CommunitiesBranchSearch = ({
    ...
    const [selectedCategoryData, setSelectedCategoryData] = useState<CommunityData[]>([]);

    const handleDisplayCategoryCommunity = (value: string, category: string) => {
        setSelectedCategory(value);
        setStrSelectedCategory(category);
        const categoryData = allCommunityData.filter((com) => String(com.categoryId) === value);
